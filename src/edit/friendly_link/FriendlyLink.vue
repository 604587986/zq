<template>
  <div id="FriendlyLink">
    ...
    <div class="table-filter">
      ...
      <el-button type="primary" size="mini" class="float-right" @click="categoryDialog = true">友情链接分类</el-button>
    </div>
            ...
            <el-table ref="multipleTable" :data="tableInfo" stripe size="small" @selection-change="handleSelectionChange">
                ...
                <el-table-column label="操作">
                    <div slot-scope="scope" class="control-btn">
                        ...
                        <el-button @click.native.prevent="delLink(scope.row.id)" size="small" class="control-btn-del">删除</el-button>
                    </div>
                </el-table-column>
            </el-table>
        </div>
...
import { linkList, editLink, delLink } from "@/api/friendly_link/friendly_link";
...
export default {
  ...
  methods: {
    ...
    //删除友情链接
    delLink(id) {
      this.$confirm("此操作将会删除该友情链接，是否继续", "提示", {
