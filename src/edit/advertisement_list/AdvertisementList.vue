<template>
  <div id="AdertisementList">
    ...
    <div class="table-filter">
      ...
      <el-button type="primary" size="mini" class="float-right" @click="categoryDialog = true">广告分类</el-button>
    </div>
            ...
            <el-table ref="multipleTable" :data="tableInfo" stripe size="small" @selection-change="handleSelectionChange">
                ...
                <el-table-column label="操作">
                    <div slot-scope="scope" class="control-btn">
                        ...
                        <el-button @click.native.prevent="delAdvertise(scope.row.id)" size="small" class="control-btn-del">删除</el-button>
                    </div>
                </el-table-column>
            </el-table>
        </div>
